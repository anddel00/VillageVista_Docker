...
public class Turno_lavoroDAOPostgresJDBCImpl implements Turno_lavoroDAO{

Connection conn;

public Turno_lavoroDAOPostgresJDBCImpl(Connection conn){this.conn = conn;}
    ...
    public List<Turno_lavoro> findAllWithDipendente() {
        ...
        try {
            String sql
                    = " SELECT t.*, d.nome_dip, d.cognome_dip "
                    + " FROM turno_lavoro t "
                    + " JOIN dipendente d ON t.id_dip_turno = d.dipid ";
            ...
            while(resultSet.next()){
                ...
                dipendente.setNome_dip(resultSet.getString("nome_dip"));
                dipendente.setCognome_dip(resultSet.getString("cognome_dip"));
                turno_lavoro.setDipendente(dipendente);
