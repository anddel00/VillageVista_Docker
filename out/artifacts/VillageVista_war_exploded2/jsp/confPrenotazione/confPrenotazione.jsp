...
<h1 class="message">PRENOTAZIONE EFFETTUATA CON SUCCESSO!</h1>
<h1 class="message-due">Grazie per averci scelto, ti aspettiamo!</h1>
<br>
<h1 class="message-due">Troverà i dettagli della prenotazione nella sua Homepage</h1>
