...
<div class="container">
    ...
    <div class="room-wrapper">
        <div class="room-card">
            <img src="images/camera_doppia.jpg" alt="Camera Matrimoniale" class="camera-doppia">
            <div class="room-description">
                <h3>Camera Matrimoniale</h3>
                <p>Perfetta per coppie, con letto matrimoniale e tutti i comfort.</p>
                <br>
                <a href="Dispatcher?controllerAction=HomeManagement.goToLoginCliente" class="verifica-button">Verifica disponibilità</a>
            </div>
        </div>
        <div class="room-card">
            <img src="images/camera_tripla.jpg" alt="Camera Tripla">
            <div class="room-description">
                <h3>Camera Tripla</h3>
                <p>Ideale per piccole famiglie, con un letto matrimoniale e un letto singolo.</p>
                <br>
                <a href="Dispatcher?controllerAction=HomeManagement.goToLoginCliente" class="verifica-button">Verifica disponibilità</a>
            </div>
        </div>
        <div class="room-card">
            <img src="images/camera_quadrupla.jpg" alt="Camera Quadrupla">
            <div class="room-description">
                <h3>Camera Quadrupla</h3>
                <p>Ottima per gruppi o famiglie, con due letti matrimoniali o quattro letti singoli.</p>
                <a href="Dispatcher?controllerAction=HomeManagement.goToLoginCliente" class="verifica-button">Verifica disponibilità</a>
            </div>
        </div>
        <div class="informazioni-aggiuntive">
            <p>Tutte le nostre camere sono dotate di:</p>
            <p class="incluso"><img src="images/condizionata.png">Aria condizionata</p>
            <p class="incluso"><img src="images/tv.png">Tv</p>
            <p class="incluso"><img src="images/cassaforte.png">Cassaforte</p>
            <p class="incluso"><img src="images/frigo.png">Frigobar</p>
            <p>È inoltre incluso il servizio biancheria da letto e da bagno</p>
            <br>
            <p>Le camere sono situate a pian terreno e fornite di un ampio patio esterno pavimentato</p>
            <p>corredato di tavolo e sedie per rilassarsi in piena tranquillità</p>
        </div>
    </div>
</div>
<script>
