...
<body>
<div class="container">
    <h1>Modifica dell'alloggio avvenuta con successo!</h1>
    <a href="Dispatcher?controllerAction=AdminHomeManagement.goToAlloggiManagement">Ritorna all'elenco alloggi</a>
</div>
</body>
</html>