...
<% Turno_lavoro turno_lavoro = (Turno_lavoro) request.getAttribute("turno_lavoro");%>
<!DOCTYPE html>
<html lang="it">
<head>
    <meta charset="UTF-8">
...
<body>
<div class="container">
    <h1>Modifica turno di lavoro</h1>
    <form action="Dispatcher" method="post">
        <input type="hidden" name="controllerAction" value="AdminHomeManagement.modTurno">
        <input type="hidden" name="turno_id" value="<%=turno_lavoro.getTurno_id()%>"><br>
        ...
        <button type="submit" value="Modifica turno">Modifica</button>
    </form>
</div>
</body>
</html>
