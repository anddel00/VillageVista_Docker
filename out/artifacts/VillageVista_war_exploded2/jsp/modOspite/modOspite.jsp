...
<div class="container">
  ...
  <form action="Dispatcher" method="post">
    <input type="hidden" name="controllerAction" value="AdminHomeManagement.modOspite">
    <input type="text" name="num_p" placeholder="Id cliente" required><br>
    ...
    <button type="submit" value="Registra ospite">Modifica dati ospite</button>
  </form>
</div>
</body>
</html>
